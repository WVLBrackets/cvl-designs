...
export async function GET() {
  const results: any = {
    ...
    envVarsPresent: {
      ...
      GOOGLE_SHEET_CONFIG_STAGING_ID: !!process.env.GOOGLE_SHEET_CONFIG_STAGING_ID,
      GOOGLE_SHEET_PRODUCTS_ID: !!process.env.GOOGLE_SHEET_PRODUCTS_ID,
      GOOGLE_SHEET_PRODUCTS_STAGING_ID: !!process.env.GOOGLE_SHEET_PRODUCTS_STAGING_ID,
